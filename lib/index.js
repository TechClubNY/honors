...
var Honors = function (_React$Component) {
    ...
    createClass(Honors, [{
        ...
        value: function componentDidMount() {
            ...
            fetch('https://techclubny.github.io/honors/data/projects/' + props.id + '.json').then(function (res) {
                return res.json();
                ...
                if (sitedata.github) {
                    fetch('https://api.github.com/repos/' + sitedata.github.org + '/' + sitedata.github.repo + '/stats/contributors').then(function (res) {
                        ...
                        if (data && data.length) {
                            _this2.setState({ contributors: _this2.state.contributors.concat(data.reverse()) });
                        }
                    });
                }
